...
def parse_train_args():
    ...
    parser.add_argument("--alpha_scale", type=float, default=8, help='controls the alphas at which training is performed by scaling them. If this is higher, then higher alphas are sampled for training. Recall that alphas correspond to diffusion time in dirichlet flow matching. alpha=1 corresponds to full noise, and alpha_max, such as alpha_max = 8 corresponds to clean data.')
