...
def parse_train_args():
    ...
    parser.add_argument("--alpha_max", type=float, default=32, help='controls the maximum value until which we run the inference process. In equation 14, we write our probability path to go from alpha=1 to alpha=infinity. In practice we cut off alpha at alpha_max.')
